...
\hypertarget{index_autotoc_md0}{}\doxysection{\texorpdfstring{Dependencies}{Dependencies}}\label{index_autotoc_md0}
To use this library, the user should download and install the \href{https://www.mpfr.org/}{\texttt{ mpfr}}, \href{https://www.multiprecision.org/mpc/}{\texttt{ mpc}}, and \href{https://github.com/opencollab/arpack-ng}{\texttt{ arpack}} libraries.\hypertarget{index_autotoc_md1}{}\doxysection{\texorpdfstring{Getting started}{Getting started}}\label{index_autotoc_md1}
This library is a template library, meaning it requires no compilation. Simply put the directory to {\ttfamily some/path/libtransftermatrices} and include {\ttfamily \doxylink{_transfer_matrices_8hpp_source}{Transfer\+Matrices.\+hpp}} in your project\+:
...
Make sure to compile with the option {\ttfamily -\/I/path/to/libtransfermatrices/include} so that the compiler sees the file {\ttfamily \doxylink{_transfer_matrices_8hpp_source}{Transfer\+Matrices.\+hpp}}.\hypertarget{index_autotoc_md2}{}\doxysection{\texorpdfstring{Usage}{Usage}}\label{index_autotoc_md2}
The library provides some convenient template classes to cover common needs in transfer matrix computations.\hypertarget{index_autotoc_md3}{}\doxysubsection{\texorpdfstring{Basis Vectors}{Basis Vectors}}\label{index_autotoc_md3}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md4}{}\doxysubsection{\texorpdfstring{Vectors}{Vectors}}\label{index_autotoc_md4}
...
One can easily iterate over all components of a vector {\ttfamily v}\+: iterate over the vector and cast the iterator to a {\ttfamily \doxylink{class_basis_vector}{Basis\+Vector}}, in our example of type {\ttfamily Ising\+PMbasis}.
...
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxysubsection{\texorpdfstring{R-\/matrices}{R-\/matrices}}\label{index_autotoc_md5}
