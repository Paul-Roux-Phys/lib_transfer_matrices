...
Full examples can be found in the folder \href{../examples/ising/}{\texttt{ examples/ising}}. The three files are visible below. The program can be compiled by navigating to the \href{../examples/ising}{\texttt{ examples/ising}} directory and typing {\ttfamily make} in a terminal. To run it, type {\ttfamily ./bin/ising}.
