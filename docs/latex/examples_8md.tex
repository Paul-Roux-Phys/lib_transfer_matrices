\chapter{examples.\+md}
\hypertarget{examples_8md}{}\label{examples_8md}\index{examples.md@{examples.md}}
\hypertarget{examples_8md_autotoc_md1}{}\doxysection{\texorpdfstring{Purpose of this library}{Purpose of this library}}\label{examples_8md_autotoc_md1}
...
where the $R_i$ are sparse matrices, in the sense that there exists a basis $|e_i \rangle$ such that $R |e_i \rangle$ has only a few non-\/zero components in the basis $|e_i\rangle$.\hypertarget{examples_8md_autotoc_md2}{}\doxysection{\texorpdfstring{Installation}{Installation}}\label{examples_8md_autotoc_md2}
This library is a template library, meaning the library itself requires no compilation. Simply put the directory to {\ttfamily some/path/libtransftermatrices} and include {\ttfamily \doxylink{_transfer_matrices_8hpp_source}{Transfer\+Matrices.\+hpp}} in your project\+:
...
Make sure to compile with the option {\ttfamily -\/I/path/to/libtransfermatrices/include} so that the compiler sees the file {\ttfamily \doxylink{_transfer_matrices_8hpp_source}{Transfer\+Matrices.\+hpp}}.\hypertarget{examples_8md_autotoc_md3}{}\doxysubsection{\texorpdfstring{Dependencies}{Dependencies}}\label{examples_8md_autotoc_md3}
...
These libraries need to be installed on your system in order to use the library. The easiest way to achieve this is in your console, via your system\textquotesingle{}s package manager; here are a few examples for popular packages managers
