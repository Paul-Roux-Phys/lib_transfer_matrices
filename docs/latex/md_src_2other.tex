\chapter{Usage}
\hypertarget{md_src_2other}{}\label{md_src_2other}\index{Usage@{Usage}}
\label{md_src_2other_autotoc_md3}%
\Hypertarget{md_src_2other_autotoc_md3}%


The library provides some convenient template classes to cover common needs in transfer matrix computations. This page describes, thanks to an example, how the library is intended to be used.\hypertarget{md_src_2other_autotoc_md4}{}\doxysection{\texorpdfstring{Data types}{Data types}}\label{md_src_2other_autotoc_md4}
\hypertarget{md_src_2other_autotoc_md5}{}\doxysubsection{\texorpdfstring{Basis Vectors}{Basis Vectors}}\label{md_src_2other_autotoc_md5}
...
For the complete documentation of this class click \doxylink{class_basis_vector}{here}.\hypertarget{md_src_2other_autotoc_md6}{}\doxysubsection{\texorpdfstring{Vectors}{Vectors}}\label{md_src_2other_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{md_src_2other_autotoc_md7}{}\doxysection{\texorpdfstring{R-\/matrices}{R-\/matrices}}\label{md_src_2other_autotoc_md7}
...
Now {\ttfamily v.\+r\+\_\+matrix(2)} will multiply v by $R_2$.\hypertarget{md_src_2other_autotoc_md8}{}\doxysection{\texorpdfstring{A transfer matrix}{A transfer matrix}}\label{md_src_2other_autotoc_md8}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keyword}{const}\ \textcolor{keywordtype}{int}\ L\ =\ 8;\ \textcolor{comment}{//\ lattice\ of\ width\ 7}}
\DoxyCodeLine{\textcolor{keyword}{class\ }IsingState\ :\ \textcolor{comment}{//\ ...}}
\DoxyCodeLine{\{}
\DoxyCodeLine{\textcolor{keyword}{public}:}
...
\end{DoxyCode}
\hypertarget{md_src_2other_autotoc_md9}{}\doxysection{\texorpdfstring{Diagonalisation}{Diagonalisation}}\label{md_src_2other_autotoc_md9}
TODO

\doxysectlink{md_src_2other}{See also}{0} 